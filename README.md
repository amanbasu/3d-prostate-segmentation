...
This repository contains files related to automatic prostate segmentation from MR Images. The dataset is provided by [PROMISE12 challenge](https://promise12.grand-challenge.org).
