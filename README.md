...
This repository contain files related to automatic prostate segmentation from MR Images using fully convolutional neural networks. The dataset is provided by [PROMISE12 challenge](https://promise12.grand-challenge.org). The poster was presented at **Nvidia GTC 2019** [(poster link)](https://www.nvidia.com/en-us/gtc/poster-gallery/ai-and-deep-learning/#img31). 
